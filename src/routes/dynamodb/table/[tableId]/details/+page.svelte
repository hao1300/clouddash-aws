        ...
        tabs={[
            {
                id: "explore",
                label: "Explore",
                href: `/dynamodb/table/${encodeURIComponent(tableName)}/explore`,
            },
            {
                id: "details",
                label: "Details",
                href: `/dynamodb/table/${encodeURIComponent(tableName)}/details`,
            },
        ]}
        activeTab="details"
    />
    <div class="flex-1 relative overflow-auto p-4 bg-gray-950">
        {#if error}<div
        ...
        {#if loading && !tableSchema}
            <div class="flex items-center justify-center h-48 text-gray-500">
                <Icon path={mdiRefresh} size={24} class="animate-spin mr-3" /> Loading
                table details...
            </div>
        {:else if tableSchema}
                ...
                >
                    ...
                    >
                        ...
                        <button
                            onclick={() => {
                                editBillingMode =
                                    tableSchema.BillingModeSummary
        ...
        <div class="space-y-4">
            ...
            {#if editBillingMode === "PROVISIONED"}
                <div class="flex gap-4">
                    <div class="flex-1">
                        <label
                            class="block text-xs font-bold text-gray-400 mb-1"
